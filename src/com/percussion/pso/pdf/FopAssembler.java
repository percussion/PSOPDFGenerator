/*
 * com.percussion.pso.pdf FopAssembler.java
 *  
 * @author DavidBenua
 *
 */
 ...
 * </p>
 * <p>
 * The FOP Assembler can used to generate any of the formats that FOP supports. If the MIME type specified in
 ...
 * These can be added to the <code>Rhythmyx/rxconfig/Workbench/mimemapwb.properties</code> file. 
...
public class FopAssembler extends PSVelocityAssembler implements IPSAssembler
{
    ...
    */
   private static String[] validMimeTypes = {MimeConstants.MIME_PDF, 
